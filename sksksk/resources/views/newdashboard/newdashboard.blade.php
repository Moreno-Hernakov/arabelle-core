...
<html>
    <head>
        ...
        <!-- Custom CSS -->
        <link href="/js/dist/chartist.min.css" rel="stylesheet">
        <link rel="stylesheet" href="/js/dist2/chartist-plugin-tooltip.css">
            ...
            <div id="main-wrapper">
                ...
                ***********************************-->
                <div class="nav-header">
                    <a href="index copy.html" class="brand-logo">
                            ...
                            <div class="collapse navbar-collapse justify-content-between">
                                <div class="header-left">
                                    <div class="dashboard_bar">
                                        <page-title-component></page-title-component>
                                    </div>
                                </div>
                                <ul class="navbar-nav header-right">  
                                    <li class="nav-item header-profile">
                                        <!-- <div class="btn-group dropleft"> 
                                            <button  data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="border:none; ">
