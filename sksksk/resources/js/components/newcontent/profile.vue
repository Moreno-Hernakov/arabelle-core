<template>
    <div>
        ...
        <div v-else>
            <div v-if="$route.params.idnya">
                <h1>{{$route.params.idnya}}</h1>
            </div>
            <div v-else>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="profile card card-body px-3 pt-3 pb-0">
                            <div class="profile-head">
                                ...
                                <div class="profile-info" v-for="u in user">
                                    ...
                                    <div class="card-body">
                                        <div class="profile-statistics">
                                            <div class="text-center">
                                                <div class="row">
                                                    <div class="col" >
                                                        <h3 class="m-b-0">{{folss.followers}}</h3><span>Follower</span>
                                                    </div>
                                                    <div class="col"  >
                                                        <h3 class="m-b-0">{{folss.following}}</h3><span>Following</span>
                                                    </div>
                                                    <div v-for="jml in user" class="col">
                                                        <h3 class="m-b-0">{{jml.my_model.length}}</h3><span>Post</span>
                                                    </div>
                                                </div>
                                                <div class="mt-4">
                                        ...
                                        <div class="tab-content">                                
                                            ...
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-4">
                                                    <div v-if="item.length >= 1" v-for="item in postImages"  class="row ">
                                                        <!-- ====================================================== -->                                            
                                                        <div v-for="i in item" class="col-4 mb-3">
                                            ...
                                            <div id="profile-settings" class="tab-pane fade">
                                                <div class="pt-3">
                                                    <div v-for="p in user" class="settings-form">
                                                        ...
                                                        <div class="profile-photo d-flex w-100 justify-content-center mb-3" >
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-6">
                                                                    ...
                                                                    <input v-model="p.email"  placeholder="Email" class="form-control">
                                                                </div>
                                                                <div class="mb-3 col-md-6">
                                                                    <label class="form-label">Username</label>
                                                                    <input  v-model="p.username"  placeholder="Username" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <button @click="updateFunc(p.email, p.username, p.id)" class="btn btn-primary" >
                                                                Update Profile
                                                            </button>
    ...
    export default {
        ...
        methods: {
            ...
            uploadImg(e){
                ...
                this.files = files
                var pictnya = new FormData()
                pictnya.append('photo',this.files)
                // console.log(this.files)
                axios.post('api/updateUserImg', pictnya, {
                    headers: {
